    ...
    <div className=" container mx-auto px-4 py-16 max-w-7xl">
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <Card
          title="رؤيتنا"
          icon_src={img5}
          description="نسعى لأن نكون الشركة الرائدة عالمياً في تقديم حلول تكنولوجية مبتكرة تساهم في تحقيق التفوق الرقمي وتعزيز تواجدها على الإنترنت بشكل فريد ومتميز."
        />
        <Card
          icon_src={img3}
          title="رسالتنا"
          description="نعمل على تمكين عملائنا من خلال تقديم حلول تصميم وتطوير مواقع وتطبيقات هواتف محمولة تجمع بين الإبداع والتكنولوجيا المتقدمة وتجربة المستخدم الفريدة لتحقيق نجاحهم الرقمي المستدام."
        />
      </div>
      ...
      <Card
        title="قيمنا"
        description="
          نحن في مؤسسة نأتي نفتخر بمجموعة من القيم الأساسية التي تقود عملياتنا
          وتبني علاقاتنا مع عملائنا وتجعلنا نتميز في تقديم حلول تكنولوجية
          متكاملة."
      >
